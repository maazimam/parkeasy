...
def is_booking_slot_covered(booking_slot, intervals):
    ...
    :param booking_slot: A BookingSlot instance with attributes start_date, start_time, end_date, end_time.
    :param intervals: A list of tuples (start_dt, end_dt), where each is a datetime object.
    :return: True if the booking slot is covered by one of the intervals, otherwise False.
    """
...
def is_booking_covered_by_intervals(booking, intervals):
    ...
    :param booking: A Booking instance with related booking slots accessible via booking.slots.all()
    :param intervals: A list of tuples (start_dt, end_dt) representing new availability intervals.
    :return: True if all booking slots are covered, otherwise False.
    """
