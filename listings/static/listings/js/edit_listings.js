document.addEventListener("DOMContentLoaded", function() {
    ...
    // Update form indices after adding or removing slots, preserving select values via selectedIndex.
    ...
    // If a blocking warning message was passed from the server, show it.
