...
class ListingAdmin(admin.ModelAdmin):
    list_display = ['title', 'user', 'location_name', 'rent_per_hour', 'has_ev_charger', 
                    'parking_spot_size', 'created_at', 'rating_display']
    ...
    fieldsets = (
        ...
        ('Pricing', {
            'fields': ('rent_per_hour',)
        }),
        ('Parking Features', {
            'fields': ('parking_spot_size', 'has_ev_charger', 'charger_level', 'connector_type')
        }),
        ('Metadata', {
