...
from accounts.models import Notification, VerificationRequest, Profile
...
class AdminVerificationViewsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.admin_verify_user_with_doc_url = reverse('admin_verify_user', args=[self.user_with_doc.id])
        self.admin_verify_verified_user_url = reverse('admin_verify_user', args=[self.verified_user.id])
    ...
    def test_admin_verify_user_decline_with_reason(self):
        ...
        self.assertEqual(self.verification_request.decline_reason, "Document not clear enough.")
...
class NotificationViewsTest(TestCase):
    ...
    def test_admin_send_notification_post_all_users(self):
        ...
        self.assertEqual(response.context['recipient_count'], 3)  # should be all non-admin users
